...
from backgauge_sim_controller import AxisConfig, BackgaugeSimController
...
class BackgaugeApp(ctk.CTk):
    def __init__(self):
        super().__init__()
        self.title("Visionary Metals Backgauge Control - UI + Sim Controller")
        ...
        self.controller = BackgaugeSimController(
        ...
        self.status_label = ctk.CTkLabel(bottom_frame, text="SIM MODE  |  IDLE", anchor="w", font=STATUS_FONT)
